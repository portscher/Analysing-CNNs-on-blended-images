...
from architectures.vision_transformer.vit_layers import Conv2dSame, Linear
...
def build_model_with_cfg(
    ...
    num_classes_pretrained = 0 if features else getattr(model, 'num_classes', kwargs.get('num_classes', 8))
    if pretrained:
